export default {
        ...
        <div class="row"> <!-- 2-up for nav and media info -->
            ...
            <div class="col-12 col-sm-9 media-info">
                ...
                <ul class="media-genres">
                    ...
                    <li>
                        <a @click.prevent="filterMovies('fantasy')" href="fantasyr">Fantasy</a>
                    </li>
                    <li>
                ...
                <section>
                    <moviethumb v-for="(item, index) in retrievedMedia" :key="index" :movie="item"></moviethumb>
                </section>
    ...
    methods: {
        filterMovies(genre) {
            if (genre === 'all') {
                loadMedia(null, 'movies')
            } else {
                loadMedia(filter, 'movies')
            }
        },
